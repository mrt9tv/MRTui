...
- **SDK Integration**: iRacing SDK (SVappsLAB.iRacingTelemetrySDK v2.3.0) for real-time telemetry
...
**Package**: `SVappsLAB.iRacingTelemetrySDK` v2.3.0. Its source generator needs Roslyn 5.9, which means .NET SDK 10.0.400 or newer; `global.json` rolls forward to it. On an older SDK the build fails with CS9057.
