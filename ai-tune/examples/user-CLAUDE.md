...
| bd-planner | Beads issue planning |
| bd-task-agent | Beads task execution |
...
Customize for your editor:
- VS Code: Use integrated terminal and tasks
- Zed: Agent Panel for file tracking
